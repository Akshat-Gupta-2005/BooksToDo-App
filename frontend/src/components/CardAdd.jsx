...
const Card = (props) => {
    ...
    return (
        <div className='Block'> 
            <img className='Left' src={props.element.volumeInfo.imageLinks.smallThumbnail?props.element.volumeInfo.imageLinks.smallThumbnail:props.element.volumeInfo.imageLinks.thumbnail} alt="asd" />
